...
const Slider = () => {
  ...
  return (
    <div className="slider-component w-1/2 h-36 bg-white-400 border-2 border-black rounded-lg flex-row mt-3">
      ...
      <div className="contorl-pane flex flex-col grow h-1/2 mt-3 p-2">
        <input
          ...
          className="slider w-full h-2 rounded-lg outline-none"
        ></input>
